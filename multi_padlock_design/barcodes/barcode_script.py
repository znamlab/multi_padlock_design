...
def main():
    ...
    # greedy_panel = bar.multi_restart_greedy(
    #     n=10, d=4, seed=50, candidates=candidates
    # )
    greedy_panel, distribution = bar.parallel_greedy(
        n=13, d=5, restarts=20, candidates=candidates
    )
    # with open(
    #     "/nemo/lab/znamenskiyp/home/users/colasa/code/multi_padlock_design/"
    #     "constrained_panel/1495_d4_10bp_barcodes.txt",
    #     "r",
    # ) as f:
    ...
    with open(
        os.path.join(savedir, f"{len(greedy_panel)}_d4_10bp_barcodes.txt"), "w"
    ) as f:
        for i, code in enumerate(greedy_panel):
            f.write(f"{i},{code}\n")

    #    improved_greedy, distribution = bar.parallel_local_improvement(
    #        greedy_panel,
    #        candidates,
    #        d=4,
    #        max_passes=5,
    ...
    #   with open(
    #       os.path.join(
    #           savedir, f"{len(improved_greedy)}_d4_10bp_barcodes_improved.txt"
    #       ),
    #       "w",
    #   ) as f:
